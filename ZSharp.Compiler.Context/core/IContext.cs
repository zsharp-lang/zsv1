...
namespace ZSharp.Compiler
{
    public interface IContext
    {
        ...
        public T? FindFirstContext<T>(IContextChainStrategy? strategy = null)
        ...
        public IEnumerable<T> FindContext<T>(IContextChainStrategy? strategy = null)
            where T : class, IContext
        {
            strategy ??= DefaultStrategy;
